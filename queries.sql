...
-- and count of vehicles. The first_name should be ordered in ascending order. Your output 
-- should look like this:

SELECT o.first_name, o.last_name, COUNT(*) AS total_vehicles
FROM owners o
JOIN vehicles v
ON o.id = v.owner_id
GROUP BY o.id
...
--  first_name | last_name | total_vehicles 
-- ------------+-----------+----------------
--  Alex       | Miller    |              1
--  Jane       | Smith     |              2
--  Melody     | Jones     |              2
...
-- cars as integers. Display the owners first_name, last_name, average price and count of 
-- vehicles. The first_name should be ordered in descending order. Only display results with 
-- more than one vehicle and an average price greater than 10000. Your output should look like 
-- this:
